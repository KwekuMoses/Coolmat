<?php
/**
 * cool-mat functions and definitions
 *
...
function coolmat_setup() {
	/*
		...
		* If you're building a theme based on cool-mat, use a find and replace
...
function coolmat_scripts() {
	...
	wp_enqueue_style( 'coolmat-custom-style', get_stylesheet_directory_uri() . "./css/custom.css" );
